#include "ggo_mosaic_bitmap_artist.h"
...
namespace
{
  ...
  //////////////////////////////////////////////////////////////
  class mosaic_artist_t : public ggo::artist
  {
  public:

    //////////////////////////////////////////////////////////////
    mosaic_artist_t(int width, int height) : artist(width, height) {}

    //////////////////////////////////////////////////////////////
    template <ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order>
    void render_bitmat(void * buffer, int line_byte_step)
    {
...
//////////////////////////////////////////////////////////////
void ggo::mosaic_bitmap_artist::render_bitmap(void * buffer, int width, int height, int line_byte_step, ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order) const
{
  mosaic_artist_t artist(width, height);

  artist.render_bitmat<ggo::pixel_type::rgb_8u, ggo::lines_order::up>(buffer, line_byte_step);
}
