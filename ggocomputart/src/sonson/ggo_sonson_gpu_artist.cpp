...
//////////////////////////////////////////////////////////////
ggo::sonson_gpu_artist::sonson_gpu_artist()
:
progress_gpu_artist(sonson_artist::duration)
{
...
//////////////////////////////////////////////////////////////
std::map<std::string, ggo::uniform> ggo::sonson_gpu_artist::update(float progress, ggo::size render_size)
{
  std::map<std::string, ggo::uniform> uniforms;

  auto circles = _artist.get_circles(progress);
