...
//
////////////////////////////////////////////////////////////////
//ggo::badaboum_realtime_artist::badaboum_realtime_artist(int width, int height, int line_byte_step, ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order)
//:
//fixed_frames_count_realtime_artist_abc(width, height, line_byte_step, pixel_type, memory_lines_order),
//_artist(width, height, line_byte_step, pixel_type, memory_lines_order, ggo::sampling_1)
//{
//}
//
////////////////////////////////////////////////////////////////
