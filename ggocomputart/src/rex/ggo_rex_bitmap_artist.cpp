#include "ggo_rex_bitmap_artist.h"
...
namespace
{
  ...
  public:
    ...
    //////////////////////////////////////////////////////////////
    rex_artist(int width, int height) : artist(width, height) {}

    //////////////////////////////////////////////////////////////
    template <ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order>
    void render_color_triangles(void * buffer, int line_byte_step, const ggo::scene2d<ggo::rgb_8u> & color_triangles) const
    {
    ...
    //////////////////////////////////////////////////////////////
    template <ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order>
    void render_patterns(void * buffer, int line_byte_step, const std::vector<rex_pattern_triangle> & pattern_triangles) const
    {
      ggo::image_t<pixel_type, memory_lines_order> img(buffer, size(), line_byte_step);
    ...
    //////////////////////////////////////////////////////////////
    template <ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order>
    void render_clipped_discs(void * buffer, int line_byte_step,
    ...
    //////////////////////////////////////////////////////////////
    template <ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order>
    void render_edges(void * buffer, int line_byte_step, const std::vector<ggo::segment_f> & edges) const
    {
      ggo::image_t<pixel_type, memory_lines_order> img(buffer, size(), line_byte_step);
    ...
    void render_bitmap(void * buffer, int line_byte_step, ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order) const
    {
      ...
      {
        render_color_triangles<ggo::pixel_type::rgb_8u, ggo::lines_order::up>(buffer, line_byte_step, color_triangles);
        render_patterns<ggo::pixel_type::rgb_8u, ggo::lines_order::up>(buffer, line_byte_step, pattern_triangles);
        render_clipped_discs<ggo::pixel_type::rgb_8u, ggo::lines_order::up>(buffer, line_byte_step, discs_clip_triangles, opened_discs);
        render_edges<ggo::pixel_type::rgb_8u, ggo::lines_order::up>(buffer, line_byte_step, edges);
      }
      else if (pixel_type == ggo::pixel_type::bgrx_8u && memory_lines_order == ggo::lines_order::down)
      {
        render_color_triangles<ggo::pixel_type::bgrx_8u, ggo::lines_order::down>(buffer, line_byte_step, color_triangles);
        render_patterns<ggo::pixel_type::bgrx_8u, ggo::lines_order::down>(buffer, line_byte_step, pattern_triangles);
        render_clipped_discs<ggo::pixel_type::bgrx_8u, ggo::lines_order::down>(buffer, line_byte_step, discs_clip_triangles, opened_discs);
        render_edges<ggo::pixel_type::bgrx_8u, ggo::lines_order::down>(buffer, line_byte_step, edges);
      }
      else
      {
        GGO_FAIL();
...
//////////////////////////////////////////////////////////////
void ggo::rex_bitmap_artist::render_bitmap(void * buffer, int width, int height, int line_byte_step, ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order) const
{
  rex_artist artist(width, height);
