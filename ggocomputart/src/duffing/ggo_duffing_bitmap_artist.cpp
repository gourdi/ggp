...
{
  //////////////////////////////////////////////////////////////
  class duffing_artist : public ggo::artist
  {
  public:

    //////////////////////////////////////////////////////////////
    duffing_artist(int width, int height) : artist(width, height) {}
    ...
    void render_bitmap(void * buffer, int line_byte_step) const
    {
      ...
      ggo::image_t<ggo::pixel_type::rgb_32f, memory_lines_order> img_float(size());
      ...
      ggo::image_t<ggo::pixel_type::y_32f, memory_lines_order> img_shadow(size());
      ...
      ggo::blit(img_float, ggo::image_t<pixel_type, memory_lines_order>(buffer, size(), line_byte_step));
    }
  };
}

//////////////////////////////////////////////////////////////
void ggo::duffing_bitmap_artist::render_bitmap(void * buffer, int width, int height, int line_byte_step, ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order) const
{
  duffing_artist artist(width, height);
