...
//////////////////////////////////////////////////////////////
ggo::trees_artist::trees_artist(int width, int height, int line_byte_step, ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order)
:
...
////////////////////////////////////////////////////////////////
std::vector<ggo::polygon2d_f> ggo::trees_artist::create_tree(const std::vector<ggo_rule> & rules, int max_depth, float y) const
{
...
////////////////////////////////////////////////////////////////
void ggo::trees_artist::render_tree(void * buffer, const std::vector<ggo::polygon2d_f> & tree_polygons, float hue, float dhue, float val) const
{
  ggo::image_t<ggo::pixel_type::rgb_8u, ggo::lines_order::up> img(buffer, size(), line_byte_step());
