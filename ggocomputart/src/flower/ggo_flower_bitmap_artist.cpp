#include "ggo_flower_bitmap_artist.h"
...
{
  //////////////////////////////////////////////////////////////
  class flower_artist : public ggo::artist
  {
  public:

    //////////////////////////////////////////////////////////////
    flower_artist(int width, int height) : artist(width, height) {}
    ...
    void render_bitmap(void * buffer, int line_byte_step) const
    {
      ...
      ggo::image_t<ggo::pixel_type::rgb_32f, memory_lines_order> img_32f(size());
      ...
      ggo::blit(img_32f, ggo::image_t<pixel_type, memory_lines_order>(buffer, size(), line_byte_step));
    }
  };
}

//////////////////////////////////////////////////////////////
void ggo::flower_bitmap_artist::render_bitmap(void * buffer, int width, int height, int line_byte_step, ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order) const
{
  flower_artist artist(width, height);
