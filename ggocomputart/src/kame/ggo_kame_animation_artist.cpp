...
//////////////////////////////////////////////////////////////
ggo::kame_animation_artist::kame_animation_artist(int width, int height, int line_byte_step, ggo::pixel_type pixel_type, ggo::lines_order memory_lines_order)
:
...
//////////////////////////////////////////////////////////////
void ggo::kame_animation_artist::kame::paint(ggo::image_t<ggo::pixel_type::y_8u, ggo::lines_order::up> & img) const
{
  std::vector<ggo::unordered_pair<const pos3_f *>> edges;

  ggo::scene2d<uint8_t> triangles;
...
void ggo::kame_animation_artist::render_frame(void * buffer, int frame_index, float time_step)
{
  ...
  if (buffer != nullptr)
  {
    ggo::image_t<ggo::pixel_type::y_8u, ggo::lines_order::up> img(buffer, size());
    ...
    ggo::blit(img, image_t<ggo::pixel_type::rgb_8u, ggo::lines_order::up>(buffer, size(), line_byte_step()));
  }
}
