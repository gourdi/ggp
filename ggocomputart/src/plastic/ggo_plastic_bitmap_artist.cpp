...
//////////////////////////////////////////////////////////////
ggo::plastic_bitmap_artist::plastic_bitmap_artist(int width, int height, int line_step, ggo::image_format format)
:
...
void ggo::plastic_bitmap_artist::render_bitmap(void * buffer) const
{
  ...
  artist.render(buffer, get_line_step(), get_format(), params, color, altitude_factor);
}
