...
//////////////////////////////////////////////////////////////
ggo::chryzode_animation_artist::chryzode_animation_artist(int render_width, int render_height)
:
...
void ggo::chryzode_animation_artist::init_sub()
{
  ...
  _radius_start = ggo::rand<float>(0.2f, 0.35f) * get_render_min_size();
  _radius_end = ggo::rand<float>(0.2f, 0.35f) * get_render_min_size();
