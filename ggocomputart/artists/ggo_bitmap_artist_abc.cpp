...
{
	std::unique_ptr<ggo::animation_artist_abc> artist(ggo::animation_artist_abc::create(_artist_id, get_render_width(), get_render_height()));
...
//////////////////////////////////////////////////////////////
ggo::bitmap_artist_abc::bitmap_artist_abc(int render_width, int render_height)
:
...
//////////////////////////////////////////////////////////////
ggo::bitmap_artist_abc * ggo::bitmap_artist_abc::create(bitmap_artist_id artist_id, int render_width, int render_height)
{
	switch (artist_id)
	{
	case ggo::bitmap_artist_id::duffing:
		return new ggo::duffing_bitmap_artist(render_width, render_height);
	case ggo::bitmap_artist_id::trees:
		return new ggo::trees_artist(render_width, render_height);
	case ggo::bitmap_artist_id::worms:
		return new ggo::worms_artist(render_width, render_height);
	case ggo::bitmap_artist_id::flower:
		return new ggo::flower_artist(render_width, render_height);
	case ggo::bitmap_artist_id::cells:
		return new ggo::cells_artist(render_width, render_height);
	case ggo::bitmap_artist_id::buddhabrot:
		return new ggo::buddhabrot_artist(render_width, render_height);
	case ggo::bitmap_artist_id::kanji:
		return new ggo::kanji_bitmap_artist(render_width, render_height);
	case ggo::bitmap_artist_id::crystal:
		return new ggo::crystal_bitmap_artist(render_width, render_height);
	case ggo::bitmap_artist_id::filling_squares:
		return new ggo::filling_squares_bitmap_artist(render_width, render_height);
	case ggo::bitmap_artist_id::voronoi:
		return new ggo::voronoi_artist(render_width, render_height);
	case ggo::bitmap_artist_id::vortex:
		return new ggo::vortex_artist(render_width, render_height);
	case ggo::bitmap_artist_id::vortex2:
		return new ggo::vortex2_bitmap_artist(render_width, render_height);
	case ggo::bitmap_artist_id::plastic:
		return new ggo::plastic_bitmap_artist(render_width, render_height);
	case ggo::bitmap_artist_id::mandelbrot:
		return new ggo::mandelbrot_artist(render_width, render_height);
	case ggo::bitmap_artist_id::mondrian:
		return new ggo::mondrian_artist(render_width, render_height);
	case ggo::bitmap_artist_id::ifs:
		return new ggo::ifs_bitmap_artist(render_width, render_height);
	case ggo::bitmap_artist_id::mosaic:
		return new ggo::mosaic_artist(render_width, render_height);
	case ggo::bitmap_artist_id::metaballs:
		return new ggo::metaballs_bitmap_artist(render_width, render_height);
	case ggo::bitmap_artist_id::marbles:
		return new ggo::marbles_artist(render_width, render_height);
	case ggo::bitmap_artist_id::julia:
		return new ggo::julia_bitmap_artist(render_width, render_height);
	case ggo::bitmap_artist_id::alpha:
		return new ggo::alpha_bitmap_artist(render_width, render_height);
	case ggo::bitmap_artist_id::dupecheck:
		return new ggo::dupecheck_bitmap_artist(render_width, render_height);
  case ggo::bitmap_artist_id::circles:
    return new ggo::circles_bitmap_artist(render_width, render_height);
	case ggo::bitmap_artist_id::topodoko:
    return new ggo::topodoko_artist(render_width, render_height);
	case ggo::bitmap_artist_id::rex:
		return new ggo::rex_artist(render_width, render_height);
  case ggo::bitmap_artist_id::bubble:
    return new ggo::bubbles_artist(render_width, render_height);
  case ggo::bitmap_artist_id::distorsion:
    return new ggo::distorsion_bitmap_artist(render_width, render_height);
  case ggo::bitmap_artist_id::toutouyoutou:
    return new ggo::toutouyoutou_bitmap_artist(render_width, render_height);
  case ggo::bitmap_artist_id::cumbia:
		return new ggo::cumbia_bitmap_artist(render_width, render_height);
  case ggo::bitmap_artist_id::hexa:
   	return new ggo::hexa_bitmap_artist(render_width, render_height);
  case ggo::bitmap_artist_id::chryzode:
    return new ggo::chryzode_bitmap_artist(render_width, render_height);
  case ggo::bitmap_artist_id::stoa:
    return new ggo::stoa_bitmap_artist(render_width, render_height);
  case ggo::bitmap_artist_id::entabeni:
    return new ggo::entabeni_bitmap_artist(render_width, render_height);
  case ggo::bitmap_artist_id::cabrel:
    return new ggo::cabrel_bitmap_artist(render_width, render_height);

  // animation artists.
	case ggo::bitmap_artist_id::smoke:
		return new ggo::bitmap_artist_animation_wrapper(ggo::animation_artist_id::smoke, render_width, render_height, 400);
	case ggo::bitmap_artist_id::ikeda:
		return new ggo::bitmap_artist_animation_wrapper(ggo::animation_artist_id::ikeda, render_width, render_height, 1);
	case ggo::bitmap_artist_id::lagaude:
		return new ggo::bitmap_artist_animation_wrapper(ggo::animation_artist_id::lagaude, render_width, render_height, 25);
  case ggo::bitmap_artist_id::amorosi:
    return new ggo::bitmap_artist_animation_wrapper(ggo::animation_artist_id::amorosi, render_width, render_height, 100, true);
  case ggo::bitmap_artist_id::bozons:
    return new ggo::bitmap_artist_animation_wrapper(ggo::animation_artist_id::bozons, render_width, render_height);
  case ggo::bitmap_artist_id::rah:
    return new ggo::bitmap_artist_animation_wrapper(ggo::animation_artist_id::rah, render_width, render_height, 800, true);
  case ggo::bitmap_artist_id::sonson:
    return new ggo::bitmap_artist_animation_wrapper(ggo::animation_artist_id::sonson, render_width, render_height, 200, true);
  case ggo::bitmap_artist_id::rediff:
    return new ggo::bitmap_artist_animation_wrapper(ggo::animation_artist_id::rediff, render_width, render_height, 350, true);
  case ggo::bitmap_artist_id::aggregation:
    return new ggo::bitmap_artist_animation_wrapper(ggo::animation_artist_id::aggregation, render_width, render_height, 300, true);
