...
public:
  ...
  virtual bool    update(uint8_t * output_buffer, uint8_t * bkgd_buffer, int width, int height);
...
private:
    ...
    virtual	bool	update(uint8_t * output_buffer, uint8_t * bkgd_buffer, int width, int height, int counter) = 0;
