...
GGO_TEST(test_scene, scene3)
{
  ...
  auto & sphere1_obj = scene.add_diffuse_object
    <ggo::discard_basis | ggo::discard_phong | ggo::discard_roughness, ggo::sphere3d_float, ggo::solid_color_material>
    (sphere1, ggo::red_32f());
  ...
  auto & sphere2_obj = scene.add_diffuse_object
    <ggo::discard_basis | ggo::discard_phong | ggo::discard_roughness, ggo::sphere3d_float, ggo::solid_color_material>
    (sphere2, ggo::green_32f());
  ...
  auto & sphere3_obj = scene.add_diffuse_object
    <ggo::discard_basis | ggo::discard_phong | ggo::discard_roughness, ggo::sphere3d_float, ggo::solid_color_material>
    (sphere3, ggo::blue_32f());
