...
namespace ggo
{
  ...
  public:
    ...
    point_light(const ggo::pos3f & pos, const ggo::rgb_32f & color) : _pos(pos), _color(color) {}
...
{
  //////////////////////////////////////////////////////////////
  inline ggo::rgb_32f point_light::get_color(const ggo::pos3f & pos) const
  {
    GGO_FAIL();
    return _color;
  }
  ...
  //////////////////////////////////////////////////////////////
  inline ggo::rgb_32f point_light::process_ray(const ggo::ray3d_float & ray, const intersection_data & intersection, const ggo::raytracer & raytracer, int depth, const ggo::indirect_lighting_abc * indirect_lighting, float random_variable1, float random_variable2) const
  {
    GGO_FAIL();
  ...
  //////////////////////////////////////////////////////////////
  inline ggo::rgb_32f point_light::process_segment(const ggo::pos3f & p1, const ggo::pos3f & p2, const ggo::rgb_32f & color) const
  {
    GGO_FAIL();
    return color;
  }
  ...
  //////////////////////////////////////////////////////////////
  inline ggo::rgb_32f point_light::process_background_ray(const ggo::ray3d_float & ray, const ggo::rgb_32f & color) const
  {
    GGO_FAIL();
    return color;
  }
