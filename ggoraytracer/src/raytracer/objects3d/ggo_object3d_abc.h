...
namespace ggo
{
  ...
  public:
    ...
    virtual ggo::rgb_32f                      process_ray(const ggo::ray3d_float & ray, const intersection_data & intersection, const ggo::raytracer & raytracer, int depth, const ggo::indirect_lighting_abc * indirect_lighting, float random_variable1, float random_variable2) const = 0;
    ...
    // Volumetric object.
    virtual ggo::rgb_32f                      process_segment(const ggo::pos3f & p1, const ggo::pos3f & p2, const ggo::rgb_32f & color) const = 0;
    virtual ggo::rgb_32f                      process_background_ray(const ggo::ray3d_float & ray, const ggo::rgb_32f & color) const = 0;
  };
}
