...
namespace ggo
{
  class sphere_glow : public volumetric_object_abc
  {
  public:

                                    sphere_glow(const ggo::pos3_f & pos, float radius, float opacity, const ggo::rgb_32f & color);
