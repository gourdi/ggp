#ifndef __GGO_2D_RECURSIVE_SPACE_PARTITIONNING__
#define __GGO_2D_RECURSIVE_SPACE_PARTITIONNING__

#include <ggo_space_partitionning_2d_abc.h>

namespace ggo
{
  class recursive_space_partitionning_2d : public space_partitionning_2d_abc
  {
  public:
