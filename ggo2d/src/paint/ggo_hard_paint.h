...
namespace ggo
{
  ...
  void	paint_line_vert_rgb(uint8_t * buffer, int width, int height, int x, int y_from, int y_to, const ggo::color & color);
  void	paint_line_horz_rgb(uint8_t * buffer, int width, int height, int x_from, int x_to, int y, const ggo::color & color);
