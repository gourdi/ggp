...
namespace ggo
{
  ...
  struct alpha_color_triangle
  {
    ...
    alpha_color_triangle(const ggo::triangle2d<real_t> & triangle,
      const floating_point_color_t & color1, const floating_point_color_t & color2, const floating_point_color_t & color3,
      const real_t & opacity1, const real_t & opacity2, const real_t & opacity3) :
      _triangle(triangle),
      _color1(color1), _color2(color2), _color3(color3),
      _opacity1(opacity1), _opacity2(opacity2), _opacity3(opacity3) { }
    ...
    color_t blend(int x, int y, const color_t & bkgd_color, const color_t & brush_color) const
    {
      ...
      const floating_point_color_t bkgd_color_fp = convert_color_to<floating_point_color_t>(bkgd_color);
      const floating_point_color_t brush_color_fp = convert_color_to<floating_point_color_t>(brush_color);
      const floating_point_color_t output_color_fp = opacity * brush_color_fp + (1 - opacity) * bkgd_color_fp;
