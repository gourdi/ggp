...
namespace ggo
{
  ...
  void	fill_checker(ggo::gray_image_data_abc & gray_image_data, float gray1, float gray2, int tile_size);
  void	fill_checker(ggo::rgb_image_data_abc & rgb_image_data, const ggo::color & color1, const ggo::color & color2, int tile_size);

  void	fill_color_curve(ggo::gray_image_data_abc & gray_image_data, const ggo::curve_abc<float, float> & color_curve);
  void	fill_color_curve(ggo::rgb_image_data_abc & rgb_image_data, const ggo::curve_abc<float, ggo::color> & color_curve);
