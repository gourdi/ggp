...
namespace ggo
{
  ...
  //image_t<pt, lo> scale(const image_base_t<pt, lo, void_ptr_t, owns_buffer> & input, ggo::size output_size, ggo::scaling_algo algo)
  //{
  ...
  //  image_t<pt, lo> output(output_size);
...
namespace ggo
{
  struct scaler
  {
    template <lines_order memory_lines_order, pixel_type pixel_type, typename input_image_t, typename output_image_t>
