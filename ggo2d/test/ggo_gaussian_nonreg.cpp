...
GGO_TEST(gaussian, rgb8u)
{
  ...
  gaussian_blur2d_test<ggo::rgb_8u_yu>(buffer_rgb_8u_yu.data(), width, height, line_step_rgb_8u_yu, "gaussian_rgb_8u_yu.bmp");

  // bgra_8u_yd
  const int line_step_bgra_8u_yd = 4 * width;
  std::vector<uint8_t> buffer_bgra_8u_yd(line_step_bgra_8u_yd * height);
  gaussian_blur2d_test<ggo::bgra_8u_yd>(buffer_bgra_8u_yd.data(), width, height, line_step_bgra_8u_yd, "gaussian_bgra_8u_yd.bmp");
...
GGO_TEST(gaussian, y_8u_yu)
{
  ...
  ggo::save_bmp("gaussian_y_8u_yu.bmp", buffer.data(), ggo::y_8u_yu, width, height, line_step);
}
