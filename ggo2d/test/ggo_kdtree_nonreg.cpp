...
GGO_TEST(kdtree, random_points)
{
  ...
  {
    ggo::paint_shape<ggo::rgb_8u_yu, ggo::sampling_4x4>(buffer.data(), size, size, 3 * size, ggo::disc_float({ point._pos.x(), point._pos.y() }, 2.f), ggo::white_8u());
  }
  ...
  {
    ggo::paint_shape<ggo::rgb_8u_yu, ggo::sampling_4x4>(buffer.data(), size, size, 3 * size, ggo::disc_float({ point._pos.x(), point._pos.y() }, 2.f), ggo::blue_8u());
  }
