...
HEADERS = src/MainWindow.h src src/RenderWidget.h src/ShapeFactory.h src/DiscFactory.h
SOURCES = src/main.cpp src/MainWindow.cpp src/RenderWidget.cpp src/DiscFactory.cpp
