...
GGO_TEST(oriented_box, rect_intersection)
{
  ...
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(0.f, 1.f, 1.f, 2.f)) == ggo::rect_intersection::rect_in_shape);
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(-2.f, 4.f, -1.f, 5.f)) == ggo::rect_intersection::shape_in_rect);
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(-3.f, -2.f, 0.f, 1.f)) == ggo::rect_intersection::disjoints);
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(4.f, 5.f, -1.f, 5.f)) == ggo::rect_intersection::disjoints);
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(0.f, 1.f, -2.f, -1.f)) == ggo::rect_intersection::disjoints);
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(0.f, 1.f, 4.f, 5.f)) == ggo::rect_intersection::disjoints);
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(-2.f, -1.5f, 0.f, 1.f)) == ggo::rect_intersection::disjoints);
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(3.f, 4.f, 3.5f, 4.f)) == ggo::rect_intersection::disjoints);
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(-1.f, 0.f, 3.f, 4.f)) == ggo::rect_intersection::disjoints);
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(2.f, 3.f, 0.f, 1.f)) == ggo::rect_intersection::disjoints);
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(-2.f, -1.f, 1.f, 3.f)) == ggo::rect_intersection::partial_overlap);
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(1.f, 2.f, 3.f, 4.f)) == ggo::rect_intersection::partial_overlap);
  GGO_CHECK(box.get_rect_intersection(ggo::rect_data<float>::from_left_right_bottom_top(1.f, 2.f, 0.f, 5.f)) == ggo::rect_intersection::partial_overlap);
}
