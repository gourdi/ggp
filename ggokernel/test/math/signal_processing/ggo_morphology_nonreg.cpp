...
GGO_TEST(morphology, dilatation_rectangle)
{
  ...
  ggo::dilatation_rectangle(input.data(), output.data(), 6, 5, 1, 1);
...
GGO_TEST(morphology, dilatation_disc)
{
  ...
  ggo::dilatation_disc(input.data(), output.data(), 6, 5, 2.5f);
...
GGO_TEST(morphology, erosion_rectangle)
{
  ...
  ggo::erosion_rectangle(input.data(), output.data(), 6, 5, 2, 1);
