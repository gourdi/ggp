namespace ggo
{
  ...
  public:
                        ...
                        cylinder3d(const ggo::set3<data_t> & pos, const ggo::set3<data_t> & dir, data_t radius);
    ...
    data_t              hypot_to_center(const ggo::set3<data_t> & p) const override { return ggo::hypot(ggo::line3d<data_t>(_pos, _dir, false), p); }
