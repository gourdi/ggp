namespace ggo
{
  ...
  {
    ggo::set3<T> v12(_v2 - _v1);
    ggo::set3<T> v13(_v3 - _v1);
    ...
    if (std::fabs(d) <= T(0.0001))
    {
      ...
      ggo::set3<T> v_min(min_x, min_y, min_z);
      ggo::set3<T> v_max(max_x, max_y, max_z);
  ...
  //////////////////////////////////////////////////////////////
  template <typename T, bool double_sided>
  ggo::set3<T> triangle3d<T, double_sided>::get_normal() const
  {
    ggo::set3<T>	edge1(_v2 - _v1);
    ggo::set3<T>	edge2(_v3 - _v1);
    ggo::set3<T>	normal(ggo::cross(edge1, edge2));
  ...
  //////////////////////////////////////////////////////////////
  template <typename T, bool double_sided>
  ggo::set3<T> triangle3d<T, double_sided>::get_center() const
  {
    T x = _v1.x() + _v2.x() + _v3.x();
    T y = _v1.y() + _v2.y() + _v3.y();
    T z = _v1.z() + _v2.z() + _v3.z();

    return ggo::set3<T>(x/3, y/3, z/3);
  }
  ...
  {
    ggo::set3<T> cross = ggo::cross(ggo::set3<T>(_v3 - _v1), ggo::set3<T>(_v2 - _v1));
  ...
  //////////////////////////////////////////////////////////////
  template <typename T, bool double_sided>
  std::string triangle3d<T, double_sided>::desc() const
  {
    std::ostringstream oss;
    oss << "triangle3d (" <<_v1 << ", " << _v2 << ", " << _v3 << ")";
	  return oss.str();
  }
}
