...
namespace ggo
{
  ...
  public:
                              ...
                              line3d(const ggo::pos3<data_t> & pos, const ggo::vec3<data_t> & dir, bool normalize = true);
...
namespace ggo
{
  ...
  template <typename data_t>
  bool find_closest_lines_point(const ggo::line3d<data_t> & line1, const ggo::line3d<data_t> & line2, ggo::pos3<data_t> & p1, ggo::pos3<data_t> & p2);
