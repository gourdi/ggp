...
namespace ggo
{
  ...
  public:
                          ...
                          triangle3d() {}
                          triangle3d(const ggo::set3<T> & v1, const ggo::set3<T> & v2, const ggo::set3<T> & v3) : _v1(v1), _v2(v2), _v3(v3) {}
    ...
    const ggo::set3<T> &	v3() const { return _v3; }

    ggo::set3<T> &		    v1() { return _v1; }
    ggo::set3<T> &		    v2() { return _v2; }
    ggo::set3<T> &		    v3() { return _v3; }
