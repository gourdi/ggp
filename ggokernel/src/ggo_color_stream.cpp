...
namespace ggo
{
  color_stream::color_stream(console_color c)
  {
    ...
    case console_color::GREEN:
      txt_color = FOREGROUND_GREEN | FOREGROUND_INTENSITY;
      break;
    case console_color::YELLOW:
      txt_color = FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_INTENSITY;
      break;
    case console_color::RED:
      txt_color = FOREGROUND_RED | FOREGROUND_INTENSITY;
      break;
    }
